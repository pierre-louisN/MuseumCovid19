...
$(document).ready(function()
{
	...
	var title = "";
	if (period==null){
		//alert('period is null, try again');
		period = "";
		title = 'Map of  all the objects ';
	}
	else {
		title = 'Map of  all the objects '+period+' quarantine';
	}	
	
	
	
	socket.emit('getObject', period); 
	
	//displays the Treemap
	socket.on('displayTreemap', function(numObj){
		if(!(period==null)){
		
		console.log('there is '+numObj+' objects in the database');
		console.log(period);
		}
		fileName = 'treemaps/treemap'+period+'.json';
		console.log(fileName);
		var title = "Map of  all the objects";
		//afficher la treemap 	
